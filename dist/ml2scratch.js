(function (ext) {
  ...
  var locale = {
    ...
    zh_tw: {
      ...
      set_wss_url: 'Set %s as WebSocket Server URL',
      when_received: '接收到類別',
      when_received_0: '接收到類別0時',
      when_received_1: '接收到類別1時',
      when_received_2: '接收到類別2時',
      when_received_3: '接收到類別3時',
      when_received_4: '接收到類別4時',
      when_received_5: '接收到類別5時',
      when_received_6: '接收到類別6時',
      when_received_7: '接收到類別7時',
      when_received_8: '接收到類別8時',
      when_received_9: '接收到類別9時',
      class_index: '類索引',
      label: 'label'
    }
  }
  ...
  ScratchExtensions.register('ML-Scratch', descriptor, ext);
})({});
