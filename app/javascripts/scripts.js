...
const LOCALIZED_TEXT = {
  ja: {
    ...
    upload: 'アップロード',
    help_text: "ML-Scratch用の拡張機能が追加されたScratchのページを開いて、下記の接続IDを「ID: [ ]で接続する」ブロックにコピー&ペーストしてください。",
  ...
  en: {
    ...
    upload: 'Upload',
    help_text: "Open Scratch with ML-Scratch extension added and use this ID when you connect.",
